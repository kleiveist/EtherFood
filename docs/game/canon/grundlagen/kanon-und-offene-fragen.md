...
Dokumentart und Reifegrad werden getrennt angegeben. Ein Kanondokument bleibt
auch mit offenen Einzelheiten die maßgebliche Quelle für seinen Themenbereich.

| Status | Bedeutung |
|---|---|
| **accepted** | Inhalt wurde angenommen und wird nur über eine Entscheidung geändert. |
| **working** | Aktuelle Arbeitsgrundlage mit ausdrücklich offenen Einzelheiten. |
| **proposal** | Unverbindlicher Vorschlag unter `game/concept/`. |
| **deprecated** | Durch eine neuere Quelle ersetzt und nicht mehr maßgeblich. |

`open` bezeichnet eine konkrete offene Frage im Text und keinen
Dokumentstatus.
