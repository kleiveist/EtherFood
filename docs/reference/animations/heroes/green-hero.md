...
| Aktuell dokumentiert | 5 Animationstypen; 4 davon vollständig in 8 Richtungen |
| Belegte Richtungsplätze | 33 von 200 |
| Dokumentierte GIFs | 35 |
| Frames je GIF | 16 |
...
GIF-Vorschauen der Figur. Stehen, langes Warten, Gehen und Laufen liegen in
allen acht Richtungen vor. Genervtes Warten ist als dreiteilige Folge nach
Süden dokumentiert.
...
| Spielstand | Green Hero; Stehen, langes Warten, Gehen und Laufen vollständig; genervtes Warten nur nach Süden |
| Technische Merkmale | 35 GIFs mit je 640 × 640 Pixeln, 16 Frames und 1,92 Sekunden Laufzeit |
...
| Davon vollständig in acht Richtungen | 4 |
| Aktuell belegte Richtungsplätze | 33 |
| Aktuell vorhandene GIF-Dateien | 35 |
| Aktuell in GIFs dokumentierter Umfang | 560 Frames |
...
dieser Seite nur die 35 eingebetteten GIF-Dateien. Die drei Teile des genervten
Wartens zählen als ein Animationstyp und ein belegter Richtungsplatz, aber als
drei einzelne GIF-Dateien mit insgesamt 48 Frames.
...
und `run/`. Die dreiteilige Vorschau des genervten Wartens verwendet die Pfade
`stand-very-long-1/`, `stand-very-long-2/` und `stand-very-long-3/`. In jedem
dieser Pfade liegt die vorhandene Richtung als `s.gif`.
