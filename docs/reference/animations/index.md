...
|---|---|---|---:|---|
| Held | Green Hero | Spielbarer grüner Held | 1 / 25 | [Green Hero](heroes/green-hero.md) |

`1 / 25` bedeutet: Ein Animationstyp ist derzeit mit allen acht Richtungen als
GIF dokumentiert; der vollständige Heldenstandard sieht 25 Animationstypen vor.
