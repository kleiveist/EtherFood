...
- 📝 [ADR-0001: Separate Repository Concerns by Top-Level Directory](decisions/ADR-0001-repository-layout.md)
- 📝 [ADR-0002: Organize New Runtime Code by Ownership](decisions/ADR-0002-runtime-folder-layout.md)
- 📝 [ADR-0003: Centralize Application Composition and Scene Navigation](decisions/ADR-0003-application-scenes-and-navigation.md)
- 📝 [ADR-0004: Limit Autoloads to Process-Wide Infrastructure](decisions/ADR-0004-scoped-autoload-services.md)
- 📝 [ADR-0005: Keep Runtime Dependencies One-Way and Explicit](decisions/ADR-0005-runtime-dependency-rules.md)

## 📁 Plans
- 🗂️ [Overview](plans/plans.md)
- 📝 [M01 Repository Bootstrap ExecPlan](plans/M01_repository_bootstrap.md)
- 📝 [M02 Control Entry Point](plans/M02_control_entrypoint.md)
...
- 📝 [M01 Repository Bootstrap – Abschlussbericht](reports/M01_repository_bootstrap.md)
...
[Forge2D Template documentation](index.md).
