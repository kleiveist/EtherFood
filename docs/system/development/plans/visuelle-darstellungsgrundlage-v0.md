...
mehrere Seiten verteilt. `docs/system/development/` ist im Repository der vorgesehene
...
3. Eine zentrale technische Darstellungsseite unter
   `docs/system/development/architecture/` erstellen.
...
- Die zentrale technische Seite heißt
  `docs/system/development/architecture/visuelle-darstellungsgrundlage-v0.md`.
