...
## 📝 00-grundlagen.md — ./00-grundlagen/00-grundlagen.md
...
## 📄 Seiten
- 📝 [Begriffe und Namen](begriffe-und-namen.md)
- 📝 [Kanon und offene Fragen](kanon-und-offene-fragen.md)
- 📝 [Spielvision](spielvision.md)

<!-- AUTO-GENERATED:docs-index END -->

---

## 📝 begriffe-und-namen.md — ./00-grundlagen/begriffe-und-namen.md
...
## 📝 index.md — ./00-grundlagen/index.md
...
Dieser Bereich enthält die kurze, verbindliche Grundlage des Projekts.
...
## 📝 kanon-und-offene-fragen.md — ./00-grundlagen/kanon-und-offene-fragen.md
...
| Stufe | Bedeutung |
|---|---|
| **draft-canon** | Inhalt ist als Projektgrundlage formuliert, kann aber noch redaktionell geschärft werden. |
| **working** | Plausible Arbeitsfassung bei noch offenen Namen oder Details. |
| **proposal** | Strukturvorschlag, der noch nicht als Handlungskanon gilt. |
| **open** | Bewusst ungeklärt. |

---

## 📝 spielvision.md — ./00-grundlagen/spielvision.md
...
Der Spieler soll sich zuerst als Retter einer sterbenden Welt fühlen. Mit jedem befreiten Gebiet wird die Welt sichtbarer, lebendiger und bedeutungsvoller. Später kippt diese Fantasie: Der Held erkennt, dass seine Taten Teil eines Systems waren, und nutzt genau die dadurch gewonnene Stärke, um gegen dessen Erbauer vorzugehen.
...
- Top-down-Perspektive, orientiert am direkten Lesefluss klassischer Action-RPGs.
- Nahkampfangriff.
- Ausweichen.
- Blocken.
- Magie als Fernkampf beziehungsweise Distanzoption.

Die endgültige Taktung, Ressourcensysteme und Eingabebelegung sind noch nicht festgelegt.
...
In der Erweiterung richtet sich der Konflikt gegen die übrigen großen Ether-Entitäten. Der Held wird schließlich selbst zu einer Ether-Entität und erhält die ungewöhnliche Möglichkeit, physisch nach Era zurückzukehren. Seine spätere Rolle auf Era bleibt bewusst offen.

---

## 📝 00-kosmologie.md — ./10-welt/00-kosmologie/00-kosmologie.md
...
## 📝 era-sol-und-yol.md — ./10-welt/00-kosmologie/era-sol-und-yol.md

---
title: Era, Sol und Yol
status: draft-canon
spoiler_level: full
updated: 2026-08-30
---
...
- Lebensenergie;
- Licht;
- gewöhnliche, aufbauende Energie.

Sol ist nicht bloß ein unbelebter Stern. Sol besitzt Bewusstsein beziehungsweise eine wesensartige Existenz und steht in einer tiefen Bindung zu Yol.
...
Gemeinsam erzeugen Sol und Yol eine Schutzwirkung um Era. Diese Barriere hält die wesentlich mächtigeren Ether-Entitäten davon ab, Era direkt zu betreten und dort ihre volle Macht auszuüben.

Die Entitäten können Era daher überwiegend nur indirekt beeinflussen, etwa durch:

- Korruption;
- Pakte;
- Händler und Mittelsleute;
- Verlockungen und Tauschgeschäfte;
- das Abfangen oder Umlenken von Seelen.
...
## 📝 ether-seelen-und-pakte.md — ./10-welt/00-kosmologie/ether-seelen-und-pakte.md

---
title: Ether, Seelen und Pakte
status: draft-canon
spoiler_level: full
updated: 2026-08-30
---
...
- andere gerettet oder bedeutende gute Taten vollbracht haben;
- sich zu Heldenfiguren entwickelt haben;
- starke Erinnerungen, Bindungen und einen ausgeprägten Willen besitzen.

Für die Entitäten sind solche Seelen zugleich Nahrung, Machtquelle, Handelsgut und Währung.
...
- eine Seele an eine Entität binden;
- den Weg der Seele nach dem Tod verändern;
- Kraft, Wissen oder Vorteile versprechen;
...
Ether-Entitäten können im Spiel besiegt, geschwächt, vertrieben oder ihrer aktuellen Form beraubt werden. Sie können jedoch nicht endgültig getötet werden. Diese Regel erhält die übergeordnete Bedrohung auch nach einem Bosskampf aufrecht.

---

## 📝 hera-und-splitterwelten.md — ./10-welt/00-kosmologie/hera-und-splitterwelten.md

---
title: Hera und die Splitterwelten
...
In Hera können Welten und Sphären:

- neu erschaffen werden;
- zerstört werden;
- geteilt oder zusammengefügt werden;
- zeitweise feste, reale Formen annehmen;
- in diffuse, kaum erklärbare Zustände übergehen;
- von einer Entität geprägt werden, ohne physisch abgeschlossen zu sein.

Eine neue Ether-Entität muss nicht zwingend eine bestehende Welt erobern. Sie kann unter bestimmten Bedingungen einen eigenen Splitter oder Machtbereich hervorbringen.
...
## 📝 index.md — ./10-welt/00-kosmologie/index.md
...
Die Kosmologie erklärt das Verhältnis zwischen dem physischen Planeten Era, den Himmelskörpern Sol und Yol, der Splittersphäre Hera, dem Ether und den Seelen.
...
## 📝 zeitrechnung-auf-era.md — ./10-welt/00-kosmologie/zeitrechnung-auf-era.md
...
## 📝 zeitzyklen-und-konvektion.md — ./10-welt/00-kosmologie/zeitzyklen-und-konvektion.md
...
## 📁 00 – Kosmologie
- 🗂️ [Übersicht](00-kosmologie/00-kosmologie.md)
...
## 📁 10 – Weltgeschichte
- 🗂️ [Übersicht](10-weltgeschichte/10-weltgeschichte.md)
...
## 📁 20 – Geografie und Sphären
- 🗂️ [Übersicht](20-geografie-und-sphaeren/20-geografie-und-sphaeren.md)
- 📝 [Welten und Sphären](20-geografie-und-sphaeren/welten-und-sphaeren.md)
- 📝 [Konzeptkarte – Die Welten des Ether](20-geografie-und-sphaeren/weltenkarte-und-arbeitsnamen.md)

## 📁 40 – Fraktionen
- 🗂️ [Übersicht](40-fraktionen/40-fraktionen.md)
...
## 📝 10-weltgeschichte.md — ./10-welt/10-weltgeschichte/10-weltgeschichte.md
...
## 📝 index.md — ./10-welt/10-weltgeschichte/index.md
...
## 📝 tators-seelenplan-und-pakt-des-helden.md — ./10-welt/10-weltgeschichte/tators-seelenplan-und-pakt-des-helden.md
...
## 📝 zeitleiste.md — ./10-welt/10-weltgeschichte/zeitleiste.md
...
## 📝 20-geografie-und-sphaeren.md — ./10-welt/20-geografie-und-sphaeren/20-geografie-und-sphaeren.md
...
## 📝 index.md — ./10-welt/20-geografie-und-sphaeren/index.md
...
- [Welten und Sphären](welten-und-sphaeren.md)
- [Konzeptkarte und Arbeitsnamen](weltenkarte-und-arbeitsnamen.md)

---

## 📝 welten-und-sphaeren.md — ./10-welt/20-geografie-und-sphaeren/welten-und-sphaeren.md

---
title: Welten und Sphären
status: working-canon
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
Die vom Helden wiederhergestellte Welt liegt in einem kleinen, kontrollierten Teil Tatoks. Sie besteht aus mehreren Ebenen oder Teilwelten. Ihre genaue Anzahl, Themen und geografischen Übergänge sind noch nicht definiert.
...
## 📝 weltenkarte-und-arbeitsnamen.md — ./10-welt/20-geografie-und-sphaeren/weltenkarte-und-arbeitsnamen.md
...
| Kor / Kor's Shard | Welt und abgetrennter Splitter; zugehörige Entität nicht auf der aktuellen Zehnerliste | offen |
...
## 📝 40-fraktionen.md — ./10-welt/40-fraktionen/40-fraktionen.md
...
## 📝 grosse-ether-entitaeten.md — ./10-welt/40-fraktionen/grosse-ether-entitaeten.md
...
## 📝 index.md — ./10-welt/40-fraktionen/index.md
...
## 📝 weltenbewahrer.md — ./10-welt/40-fraktionen/weltenbewahrer.md
...
- [Welten und Sphären](20-geografie-und-sphaeren/welten-und-sphaeren.md)
- [Auswertung der Konzeptkarte](20-geografie-und-sphaeren/weltenkarte-und-arbeitsnamen.md)
...
## 📝 20-handlung.md — ./20-handlung/20-handlung.md
...
## 📝 enthuellungsstruktur.md — ./20-handlung/enthuellungsstruktur.md

---
title: Enthüllungs- und Spoilerstruktur
status: proposal
spoiler_level: critical
updated: 2026-08-30
---
...
Der Spieler entdeckt wiederholte Strukturen, nicht erreichbare Ränder, Systemzeichen, identische Seelenmuster oder Räume hinter der sichtbaren Welt. Der Talisman beginnt diese Phänomene zu entschlüsseln.
...
Die Wendung darf nicht behaupten, „alles war bedeutungslos“. Die emotionale Realität der Bewohner, Erinnerungen und geretteten Orte muss bestehen bleiben. Die Täuschung betrifft Ursprung und Zweck der Welt, nicht automatisch den Wert der darin entstandenen Beziehungen.

---

## 📝 finale-und-erweiterung.md — ./20-handlung/finale-und-erweiterung.md

---
title: Finale des Basisspiels und Erweiterung
status: draft-canon
spoiler_level: critical
updated: 2026-08-30
---
...
[← Zurück](20-handlung.md)
<!-- AUTO-GENERATED:backlink END -->
# Finale des Basisspiels und Erweiterung
...
Die Erweiterung vergrößert den Konflikt von zwei Gegnern auf die Gesamtheit der großen Ether-Entitäten. Der Held verfolgt, bekämpft oder durchkreuzt die übrigen Mächte Heras.

Im Verlauf wird er selbst zu einer Ether-Entität. Diese Entwicklung ist zugleich Gefahr und Vorteil:

- Er nähert sich den Wesen an, gegen die er kämpft.
- Seine gesammelte Seelenenergie verändert seine Existenzform.
- Er gewinnt Zugang zu Kräften und Räumen, die einer gewöhnlichen Seele verschlossen wären.
- Anders als die bekannten Entitäten besitzt er weiterhin eine direkte Herkunft aus Era.

Am Ende kann seine Seele beziehungsweise neue physische Form nach Era zurückkehren. Welche Rolle er dort einnimmt, ob er Wächter, Gefahr, Vermittler oder etwas völlig Neues wird, bleibt bewusst offen und wird in diesem Projektteil nicht weitergeführt.
...
[EF-DEC-007](../entscheidungen/ADR-0008-achtteiliger-spielablauf.md)
festgehalten.

---

## 📝 heldenraum.md — ./20-handlung/heldenraum.md
...
Das Spiel beginnt im Heldenraum, einem ruhigen und abgegrenzten Ausgangsort
innerhalb der Konstruktwelt. Der Held erwacht dort ohne Erinnerung. Als einzige
andere Figur erkennt er zunächst den kleinen
[Ratgeber](ratgeber-im-heldenraum.md). Den bereits mitgeführten
[Talisman](talisman.md) nimmt er noch nicht bewusst wahr.
...
Startfiguren sind nicht festgelegt. Auch die genaue Gestaltung und spätere
Nutzung des Raums bleiben offen.

Der vollständige Einstieg steht unter
[Spielablauf und Abschnittsstruktur](spielablauf-und-abschnittsstruktur.md).

---

## 📝 index.md — ./20-handlung/index.md
...
## 📝 praemisse.md — ./20-handlung/praemisse.md

---
title: Handlungsprämisse
status: draft-canon
spoiler_level: critical
updated: 2026-08-30
---
...
## 📝 protagonist.md — ./20-handlung/protagonist.md
...
- Er ist am Leben.
- Der Heldenraum ist ein realer Zufluchts- oder Ausgangsort.
- Die zerstörte Spielwelt ist seine tatsächliche Welt.
- Die Monster sind die Ursache des Untergangs.
- Wiederherstellung bedeutet endgültige Rettung.
...
Die Entwicklung des Helden verläuft in fünf Schritten:

1. **Orientierung:** Er akzeptiert die Aufgabe, weil sie ihm Sinn und Richtung gibt.
...
## 📝 ratgeber-im-heldenraum.md — ./20-handlung/ratgeber-im-heldenraum.md

---
title: Ratgeber im Heldenraum
status: working-canon
spoiler_level: full
updated: 2026-08-30
---
...
[← Zurück](20-handlung.md)
<!-- AUTO-GENERATED:backlink END -->
# Ratgeber im Heldenraum

## Funktion

Der Ratgeber ist beim Erwachen der einzige unmittelbar erkennbare Gefährte des
Helden. Auch er wird im [Heldenraum](heldenraum.md) wach. Er übernimmt die erste
Orientierung, ohne bereits die Wahrheit über die Konstruktwelt, Tator oder die
Vergangenheit des Helden zu erklären.

## Gestalt

- Seine Silhouette wird von einem großen Hut bestimmt.
- Zwei Augen sitzen sichtbar am Hut.
- Unter dem Hut befindet sich ein winziger, beinahe vollständig verdeckter
  Körper.
- Er fliegt auf einem Besen und kann den Helden umkreisen.
- Ratgeber ist vorläufig eine Funktionsbezeichnung und noch kein Eigenname.

Der [beibehaltene Pixel-Art-Entwurf](../../assets/images/guide-companion-variants.md)
dient der weiteren visuellen Ausarbeitung. Seine Auswahl macht ihn noch nicht
zum fertigen Produktionssprite.

## Abgrenzung vom Talisman

Ratgeber und [Talisman](talisman.md) sind nicht dieselbe Figur. Der Ratgeber ist
von Beginn an sichtbar; den Talisman bemerkt der Held erst nach dem Boss des
Lichterhauses bewusst. Ob der Ratgeber den Talisman kennt oder auf ihn reagieren
kann, bleibt offen.

## Noch offen

Eigenname, Herkunft, Wissen, Motivation, Stimme und späterer Handlungsbogen des
Ratgebers sind nicht festgelegt. Er darf grundlegende Bewegung, Interaktion,
Erkundung und frühe Gefahren erklären, ist aber kein allwissender Erzähler.

In der Top-down-Ansicht müssen Hut, Augen, Besenflug und Bewegungsmuster ihn
klar von Gegnern, Leuchtpunkten und dem Talisman unterscheiden. Farben,
Animationen und Audiohinweise werden später erprobt.

---

## 📝 spielablauf-und-abschnittsstruktur.md — ./20-handlung/spielablauf-und-abschnittsstruktur.md

---
title: Spielablauf und Abschnittsstruktur
...
[← Zurück](20-handlung.md)
<!-- AUTO-GENERATED:backlink END -->
# Spielablauf und Abschnittsstruktur

Das Basisspiel umfasst acht Makroabschnitte. Ihre Gesamtzahl und Reihenfolge
sind festgelegt. Der Graslandabschnitt ist der bisher ausführlich beschriebene
Referenzablauf; die Einzelheiten der späteren Regionen bleiben offen.
...
mit dem Ausbruch und den drei Passagen durch Tatok.

## Referenzablauf Grasland

### 1. Erwachen im Heldenraum

Der Held erwacht ohne Erinnerung im [Heldenraum](heldenraum.md). Sein einziger
unmittelbar erkennbarer Gefährte ist der kleine fliegende
[Ratgeber](ratgeber-im-heldenraum.md). Er ist nicht mit dem zunächst
unbemerkten [Talisman](talisman.md) gleichzusetzen.

### 2. Verlassenes Haus und Nebel

Vom Heldenraum führt der Weg zu einem verlassenen Haus und danach in eine fast
vollständig vom Nebel verdeckte Welt. Der Spieler findet zunächst keine
erkennbare Landschaft und folgt später auftauchenden Leuchtpunkten.

### 3. Turm als Einführungsdungeon

Die ersten Leuchtpunkte führen zu einem Turm. Leichte Gegner führen in Kampf
und Erkundung ein; am Ende steht ein regionaler Turmboss beziehungsweise
Miniboss.

Nach dem Sieg wird die Karte erstmals lesbar. Im Nebel erscheint das
wiederhergestellte Grasland als erstes zusammenhängendes Gebiet.

### 4. Freie Erkundung des Graslands

Vom Turm aus kann der Spieler das Grasland durchstreifen, mit der
wiedergekehrten Umgebung interagieren und den nächsten Dungeon suchen. Diese
Phase ist frei erkundbar und keine unmittelbare lineare Fortsetzung des Turms.

### 5. Wald- und Sägewerkdungeon: Gebäude

Der nächste Dungeon beginnt in einem Wald und führt in ein gewaltiges
industrielles Sägewerk. Es ist keine kleine mittelalterliche Werkstatt, sondern
eine überdimensionierte Holzfabrik.

Jedes besiegte Monsternest löst sichtbaren Gebäudefortschritt aus. Gebäude
kehren nach und nach zurück, werden begehbar und können früh auffindbare
Gegenstände oder andere nützliche Inhalte enthalten. Die konkreten Gegenstände
sind noch offen.

### 6. Fluss-, Wasserfall- und Wasserwerkdungeon: Bewohner

Der folgende Dungeon verläuft an einem gewaltigen Fluss und Wasserfall. Treppen
führen abschnittsweise am fallenden Wasser hinab. Wasserräder, Holzmühlen und
mechanische Holzhämmer prägen Navigation, Hindernisse und Kämpfe. Im Verlauf
werden nach und nach Menschenseelen befreit.

Die genaue Fallhöhe ist nicht festgelegt. Der Wasserfall soll monumental
wirken, ohne bereits eine verbindliche Meterangabe vorzugeben.

### 7. Lichterhaus: Seelen und Erinnerungen

Die zurückgekehrten Bewohner können sich zunächst nicht an ihre Vergangenheit
erinnern. In ihrem Dorf steht ein besonderes Haus, dessen Umriss den
Erinnerungsdungeon bildet. Statt eines durchgehenden Weges sucht der Spieler
leuchtende Lampen. Jede Lampe öffnet einen kurzen Abschnitt mit Rätsel,
Gegnerbegegnung oder beidem und befreit eine zugehörige Seele beziehungsweise
Erinnerung.

Lichterhaus ist ein redaktioneller Arbeitsbegriff und noch kein bestätigter
Eigenname. Ungefähr zwanzig kurze Abschnitte sind ein veränderbarer
Arbeitswert, keine Freigabe.

Die letzte Seele führt zum regionalen Endboss. Nach diesem Kampf bemerkt der
Held erstmals bewusst den Talisman und erhält einen kleinen Ausschnitt seiner
eigenen Vergangenheit.

### 8. Dorf als sozialer Rätselabschnitt

Der Abschluss des Graslands ist kein klassischer Dungeon. Der Spieler spricht
mit Bewohnern, erfüllt Gefallen und verbindet ihre Hinweise, um den nächsten
Weg zu erkennen. Dabei erwirbt er anwendbares Wissen und Fähigkeiten.

Im Bauerndorf stehen zunächst Landwirtschaft, der Bau eines einfachen Gebäudes
und die Vorbereitung einer Brücke oder eines ähnlichen Übergangs im
Vordergrund. Fortgeschrittene Angriffstaktiken folgen erst in späteren
Abschnitten.

## Rhythmus der ersten vier Abschnitte

Der Graslandablauf beschreibt einen Rhythmus, keine starre Schablone:

1. Einen zunächst unlesbaren oder versperrten Raum erkunden.
2. Durch einen ersten Dungeon den regionalen Zugang herstellen.
3. Landschaft und begehbares Gebiet sichtbar machen.
4. Mit weiteren Dungeons oder Monsternestern Gebäude und Bewohner
   wiederherstellen.
5. In Rätseln und Erinnerungsräumen Seelen ihre Geschichte zurückgeben.
6. Durch die Gemeinschaft Wissen oder Fähigkeiten für den nächsten Abschnitt
   erwerben.

Wald, Hochland und Hauptstadt dürfen diesen Rhythmus unterschiedlich
ausgestalten. Ihre Dungeons, Bewohner, Rätsel, Fähigkeiten und Bosse sind noch
nicht festgelegt.

## Endgame-Rhythmus

Nach der Hauptstadt ändert sich das Spielgefühl. Die drei Tatok-Abschnitte
enthalten keine erneute große Befreiungs- oder Aufbaufolge. Der Spieler wendet
das Wissen aus den vier Gemeinschaften sowie seine Fähigkeiten und vertrauten
Systeme an, um Tator zu erreichen. Der achte Abschnitt führt anschließend in
Semms Bereich und konzentriert sich auf dessen Landen und den letzten
Bosskampf.

## Noch offen

- Größe und Dauer der Abschnitte;
- Zahl, Länge und Reihenfolge der Lampenräume;
- Höhe und Geometrie des Wasserfalls;
- Gegenstände in früh wiederhergestellten Gebäuden;
- Inhalte, Fähigkeiten und Bosse von Wald, Hochland und Hauptstadt;
- Aufbau und Gegnermischung der drei Tatok-Passagen;
- genaue Gestalt von Semms Bereich.

Die zugrunde liegende Entscheidung steht in
[ADR-0008](../entscheidungen/ADR-0008-achtteiliger-spielablauf.md).

---

## 📝 talisman.md — ./20-handlung/talisman.md
...
Eingriff in Tators System mit der verlorenen Vergangenheit des Helden, der
schrittweisen Entlarvung der Konstruktwelt und der zweiten Reise durch die
bereits befreiten Welten.

Zu Beginn führt der Held ihn unbemerkt mit sich. Später wird er zum Träger
persönlicher Erinnerung, zum Deutungswerkzeug für verborgene Strukturen und
schließlich zum Speicher für Seelenmacht.

## Herkunft

Zehsen bringt den Talisman in Tators System beziehungsweise in den
[Heldenraum](heldenraum.md). Zehsen ist ein Weltenbewahrer und zugleich ein
Verbündeter Tators. Sein Eingriff bestätigt deshalb weder eine Sabotage noch
einen Angriff auf Tator. Gelehrte verschiedener Kulturen deuten seine Absicht
und Loyalität unterschiedlich; keine Deutung ist bestätigt.

## Entwicklung

| Phase | Wissen des Helden | Funktion des Talismans |
|---|---|---|
| Erwachen | Der Held weiß nicht, dass er den Talisman mitführt. | Das Objekt bleibt unbemerkt und erklärt nichts. |
| Lichterhaus im Grasland | Nach dem regionalen Boss nimmt der Held den Talisman erstmals bewusst wahr. | Er gibt einen kleinen persönlichen Erinnerungsimpuls. |
| Weitere Reise | Der Held erkennt Fehler und Widersprüche in der scheinbaren Welt. | Der Talisman hilft, verborgene Strukturen zu erkennen und zu deuten. |
| Zweite Reise | Der Held besucht bereits befreite Welten erneut. | Der Talisman nimmt nutzbare Seelenmacht beziehungsweise Seelenenergie auf. |
| Ausbruch und Endkämpfe | Der Held kennt den künstlichen Charakter der Konstruktwelt. | Die gesammelte Macht ermöglicht den Ausbruch und die folgenden Kämpfe. |
| Abschluss | Die Seelen bestehen unabhängig von der abgegebenen Macht fort. | Sie kehren nach Era zurück und treten wieder in den natürlichen Seelenkreislauf ein. |

Der Talisman darf die vollständige Wahrheit nicht bereits beim Erwachen
erklären. Die Enthüllung bleibt schrittweise.

## Seele und Seelenmacht

Der Talisman verschlingt keine Seelen. Eine Seele trägt Identität und
fortbestehende Existenz; Seelenmacht oder Seelenenergie ist die von ihr
trennbare nutzbare Kraft. Auf der zweiten Reise geben beziehungsweise verlieren
die befreiten Seelen diese Kraft an den Talisman, bleiben aber selbst bestehen.

Nach den Kämpfen kehren die Seelen nach Era zurück. Dort werden sie im
lebensnotwendigen Seelenkreislauf wiedergeboren. Der Endgame-Einsatz des
Talismans hebt ihre vorherige Befreiung daher nicht auf.

## Abgrenzung und offene Gestaltung

Der sichtbare [Ratgeber](ratgeber-im-heldenraum.md) und der Talisman sind nicht
dasselbe Wesen oder Objekt. Ob der Talisman bewusst spricht, eine Persönlichkeit
oder Stimme besitzt oder mit dem Ratgeber verbunden ist, bleibt offen.

Form, Material, Farbe, Größe, Trageweise und Oberflächenzeichen sind ebenfalls
nicht festgelegt. Der
[beibehaltene Pixel-Art-Entwurf](../../assets/images/soul-talisman-variants.md)
zeigt nur eine mögliche Richtung und begründet keinen zusätzlichen Kanon.

---

## 📝 30-spielmechanik.md — ./30-spielmechanik/30-spielmechanik.md
...
## 📝 index.md — ./30-spielmechanik/index.md
...
## 📝 kampfsystem-grundlage.md — ./30-spielmechanik/kampfsystem-grundlage.md

---
title: Kampfsystem – Grundlage
status: draft-canon
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
[← Zurück](30-spielmechanik.md)
<!-- AUTO-GENERATED:backlink END -->
# Kampfsystem – Grundlage

## Perspektive

Das Kampfsystem ist für eine Top-down-Ansicht ausgelegt. Gegnerangriffe, Gefahrenzonen und Bewegungswege müssen aus dieser Perspektive klar lesbar sein.

## Grundaktionen

| Aktion | Zweck |
|---|---|
| **Angriff** | Direkter Nahkampfschaden und Hauptmittel gegen normale Gegner. |
| **Ausweichen** | Aktive Positionsänderung, um Angriffen und Gefahrenzonen zu entkommen. |
| **Blocken** | Defensive Antwort auf lesbare Angriffe; genaue Kosten und Parierfenster sind offen. |
| **Magie/Fernkampf** | Distanzoption, Elementinteraktion und Werkzeug gegen schwer erreichbare Gegner. |

## Verbindung zur Handlung

Neue Kampfoptionen und Verbesserungen sollen bevorzugt aus Erinnerungen, historischen Erkenntnissen oder wiederhergestellten Beziehungen entstehen. Der Held lernt dadurch nicht nur „mehr Schaden“, sondern gewinnt verlorene Techniken, Haltungen oder magische Zusammenhänge zurück.

## Ziel für einen ersten Vertical Slice

Der erste spielbare Abschnitt benötigt mindestens:

- einen zuverlässigen Grundangriff;
- eine Ausweichbewegung;
- eine Blockfunktion;
- eine einfache magische Distanzaktion;
- zwei normale Gegnertypen mit unterschiedlichen Angriffsmustern;
- einen kleineren Elitegegner oder Höhlenwächter;
- eine sichtbare Weltrekonstruktion als Abschluss.

## Offene Systemfragen

- Ausdauerleiste oder Abklingzeiten.
- Leichtes und schweres Angriffssystem.
- Parade als Teil des Blocks.
- Zielerfassung oder freies Zielen.
- Manaquelle und Regeneration.
- Elementbeziehungen zu Flur, Aquars, Infa, Mitska, Eves und Seves.

---

## 📝 kernspielschleife.md — ./30-spielmechanik/kernspielschleife.md

---
title: Kernspielschleife
status: draft-canon
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
1. Der Held betritt eine beschädigte oder unvollständige Ebene.
2. Er erkundet, kämpft, findet Zugänge und erkennt die lokale Ursache der Versiegelung.
3. Er besiegt Monstergruppen und räumt eine Monsterhöhle oder einen vergleichbaren Verdichtungspunkt.
4. Er versiegelt, reinigt oder schließt die Quelle.
5. Ein Teil der Welt wird rekonstruiert.
6. Neue Landschaft, Bewohner, Gebäude, Erinnerungen oder Fähigkeiten werden verfügbar.
...
- **räumlich:** neue Wege, Natur, Gebäude oder ganze Gebiete;
- **sozial oder erzählerisch:** Bewohner, Dialoge, Erinnerungen oder historische Zusammenhänge;
- **mechanisch:** neue Fähigkeit, Werkzeug, Magie oder Interaktion.

## Zwei Phasen des Spiels

### Aufbauphase

Der Spieler glaubt, eine echte Welt wiederherzustellen. Die Schleife vermittelt Hoffnung, Wachstum und zunehmende Verbundenheit.
...
Eine Rückkehr in ein früheres Gebiet muss mindestens eine neue Begegnung, Route, Gegnerkombination, Erinnerung, Entscheidung oder Systemebene bieten. Reines Ablaufen identischer Wege soll vermieden werden.

---

## 📝 seelenenergie-im-endgame.md — ./30-spielmechanik/seelenenergie-im-endgame.md

---
title: Seelenenergie im Endgame
status: draft-canon
spoiler_level: critical
updated: 2026-08-30
---
...
## 📝 wiederherstellungsfortschritt.md — ./30-spielmechanik/wiederherstellungsfortschritt.md
...
Die Welt wird nicht auf einmal wiederhergestellt. Der Fortschritt folgt einer lesbaren Hierarchie:

1. **Länder und Gebiete** – Grundfläche, Wege, Höhenzüge, Küsten oder Ebenengrenzen.
2. **Natur und Landschaft** – Bäume, Wasser, Pflanzen, Wettereffekte und Lebensräume.
3. **Seelen und Bewohner** – einzelne Wesen, Gruppen und soziale Beziehungen.
4. **Siedlungen und Städte** – Gebäude, Infrastruktur, Handwerk und gesellschaftliche Funktionen.
5. **Erinnerungen und Geschichte** – persönliche Erinnerungen, Weltwissen, frühere Ereignisse und Identität.
6. **Fähigkeiten des Helden** – Verbesserungen, die aus den wiedergewonnenen Erinnerungen und Geschichten entstehen.

## Designabsicht

Die Reihenfolge vermittelt, dass eine Welt zuerst Raum und Lebensgrundlage benötigt, bevor Gesellschaft, Geschichte und persönliche Macht zurückkehren können. Fähigkeiten sind damit das Ergebnis von Wiederherstellung und Verständnis, nicht bloß eine isolierte Belohnung.
...
- Landschaft öffnet Wege.
- Natur erzeugt Ressourcen und Atmosphäre.
- Bewohner geben Aufgaben und Beziehungen.
- Städte bündeln Dienste und Kultur.
- Erinnerungen erklären Zusammenhänge.
- Fähigkeiten erlauben neue Lösungen in alten und neuen Gebieten.

---

## 📝 40-weltsysteme.md — ./40-weltsysteme/40-weltsysteme.md
...
## 📄 Seiten
- 📝 [Ebenen, Portale und Weltpassagen](ebenen-portale-und-weltpassagen.md)
- 📝 [Erinnerungs- und Fähigkeitssystem](erinnerungs-und-faehigkeitssystem.md)
- 📝 [Rekonstruktionssystem](rekonstruktionssystem.md)
- 📝 [Seelenökonomie](seelenoekonomie.md)
- 📝 [Sol, Yol, Zeit und Jahreszeiten als Weltsystem](sol-yol-zeit-und-jahreszeiten.md)

<!-- AUTO-GENERATED:docs-index END -->

---

## 📝 ebenen-portale-und-weltpassagen.md — ./40-weltsysteme/ebenen-portale-und-weltpassagen.md

---
title: Ebenen, Portale und Weltpassagen
status: draft-design
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
<!-- AUTO-GENERATED:backlink END -->
# Ebenen, Portale und Weltpassagen
...
- mehrere Monsterquellen oder Höhlen;
- eine Rekonstruktionsfolge;
- Bewohner und mindestens einen erinnerungsbasierten Handlungsbogen;
- einen Abschluss, der den nächsten Bereich öffnet.

## Portale

Portale verbinden Räume, die innerhalb Heras nicht normal benachbart sein müssen. Sie können kontrolliert, beschädigt, verborgen oder an Seelenenergie gebunden sein.

## Weltpassagen

Weltpassagen sind größere Übergangsräume zwischen Machtbereichen. Im Endgame erfüllen sie eine andere Funktion als normale Ebenen:
...
## 📝 erinnerungs-und-faehigkeitssystem.md — ./40-weltsysteme/erinnerungs-und-faehigkeitssystem.md

---
title: Erinnerungs- und Fähigkeitssystem
status: draft-design
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
Erinnerungen sind gleichzeitig Lore, Charakterentwicklung und Fortschrittsressource. Eine Fähigkeit verbessert sich nicht nur, weil ein abstrakter Wert steigt, sondern weil der Held eine Technik, Bindung oder Wahrheit wieder versteht.

## Erinnerungstypen

| Typ | Beispielhafte Funktion |
|---|---|
| Persönliche Erinnerung | Enthüllt Teile des früheren Lebens des Helden und kann eine individuelle Technik zurückbringen. |
| Ortsgedächtnis | Zeigt, wie ein Gebiet vor seiner Zerstörung oder Konstruktion erlebt wurde. |
| Kulturelle Erinnerung | Stellt Wissen, Handwerk, Sprache oder Rituale einer Gemeinschaft wieder her. |
| Kampferinnerung | Schaltet Angriff, Blockreaktion, Magievariation oder passive Fähigkeit frei. |
| Systemerinnerung | Enthüllt Fehler der Konstruktwelt und unterstützt den Talisman beim Entschlüsseln. |

## Fortschrittslogik

1. Ein Gebiet wird räumlich befreit.
2. Bewohner oder Seelen kehren zurück.
...
## 📝 index.md — ./40-weltsysteme/index.md
...
- [Erinnerungs- und Fähigkeitssystem](erinnerungs-und-faehigkeitssystem.md)
- [Seelenökonomie](seelenoekonomie.md)
- [Sol, Yol, Zeit und Jahreszeiten](sol-yol-zeit-und-jahreszeiten.md)
- [Ebenen, Portale und Weltpassagen](ebenen-portale-und-weltpassagen.md)

---

## 📝 rekonstruktionssystem.md — ./40-weltsysteme/rekonstruktionssystem.md
...
## 📝 seelenoekonomie.md — ./40-weltsysteme/seelenoekonomie.md

---
title: Seelenökonomie
status: draft-canon
spoiler_level: full
updated: 2026-08-30
---
...
Der Wert einer Seele steigt durch:

- Stärke und entwickelte Fähigkeiten;
- außergewöhnliche Erfahrungen;
- starke Bindungen und Erinnerungen;
...
## 📝 sol-yol-zeit-und-jahreszeiten.md — ./40-weltsysteme/sol-yol-zeit-und-jahreszeiten.md

---
title: Sol, Yol, Zeit und Jahreszeiten als Weltsystem
status: proposal
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
## 📝 50-inhalte.md — ./50-inhalte/50-inhalte.md
...
## 📄 Seiten
- 📝 [Boss- und Endgame-Abfolge](boss-und-endgame-abfolge.md)
- 📝 [Monsterhöhlen und Versiegelungen](monsterhoehlen-und-versiegelungen.md)
- 📝 [Welt- und Ebenenstruktur](welt-und-ebenenstruktur.md)

<!-- AUTO-GENERATED:docs-index END -->

---

## 📝 boss-und-endgame-abfolge.md — ./50-inhalte/boss-und-endgame-abfolge.md

---
title: Boss- und Endgame-Abfolge
...
Der Sieg muss deutlich sein, ohne einen endgültigen Tod zu behaupten. Geeignete Folgen sind:

- Manifestation zerbricht;
- Machtkern wird versiegelt;
- Entität verliert Kontrolle über die aktuelle Sphäre;
- Verbindung zur Konstruktwelt reißt ab;
- Entität wird aus ihrer Form verdrängt.
...
## 📝 monsterhoehlen-und-versiegelungen.md — ./50-inhalte/monsterhoehlen-und-versiegelungen.md

---
title: Monsterhöhlen und Versiegelungen
...
[← Zurück](50-inhalte.md)
<!-- AUTO-GENERATED:backlink END -->
# Monsterhöhlen und Versiegelungen

## Funktion

Monsterhöhlen sind Verdichtungspunkte der Konstruktwelt. Sie halten Landschaft, Bewohner, Städte oder Erinnerungen gebunden und liefern dem Helden klare lokale Ziele.

Der Begriff „Höhle“ ist funktional zu verstehen. Eine Monsterquelle kann auch sein:

- ein unterirdischer Bau;
- eine Ruine;
- ein Turm;
- ein Riss im Raum;
- ein verseuchter Waldkern;
- eine künstliche Systemkammer;
- ein wanderndes Monstergebilde.

## Abschlussformen

Je nach Region kann der Held die Quelle:

- reinigen;
- versiegeln;
- schließen;
- zerstören;
- von einer gebundenen Seele trennen;
- gegen einen neuen Zweck umprogrammieren.

## Verbindung zur Wahrheit

Frühe Monsterhöhlen wirken wie natürliche Brutstätten des Bösen. Spätere Quellen sollen erkennen lassen, dass sie absichtlich platziert, wiederverwendet oder von einem System verwaltet werden. Dadurch bereitet der Content die Enthüllung spielerisch vor.

## Mindestinhalt pro Quelle

- eindeutiges visuelles Motiv;
- mindestens ein eigener Gegnermix;
...
## 📝 welt-und-ebenenstruktur.md — ./50-inhalte/welt-und-ebenenstruktur.md

---
title: Welt- und Ebenenstruktur
status: content-outline
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
Die Erweiterung kann die auf der Entitäten- und Sphärenübersicht gezeigten Mächte als eigenständige Großräume nutzen. Dabei muss nicht jede Entität eine klassische Welt besitzen; einige können Schwärme, bewegliche Räume, lebende Sphären oder diffuse Wirklichkeitsfelder kontrollieren.

---

## 📝 60-produktion.md — ./60-produktion/60-produktion.md
...
## 📝 erster-spielbarer-abschnitt.md — ./60-produktion/erster-spielbarer-abschnitt.md
...
## 📝 index.md — ./60-produktion/index.md
...
- [Erster spielbarer Abschnitt](erster-spielbarer-abschnitt.md)
- [Scope von Basisspiel und Erweiterung](scope-basisspiel-und-erweiterung.md)
- [Narrative Umsetzungsregeln](narrative-umsetzungsregeln.md)
- [Nächste Konzeptschritte](naechste-konzeptschritte.md)

---

## 📝 naechste-konzeptschritte.md — ./60-produktion/naechste-konzeptschritte.md

---
title: Nächste Konzeptschritte
status: planning
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
## 📝 narrative-umsetzungsregeln.md — ./60-produktion/narrative-umsetzungsregeln.md

---
title: Narrative Umsetzungsregeln
...
Die Behauptung, der Held rette seine wirkliche Welt, darf nicht von Beginn an offensichtlich falsch wirken. Frühe Figuren, Quests und Rekonstruktionen müssen emotional funktionieren.

## 2. Die Wendung darf Erfolge nicht entwerten

Die Welt ist konstruiert, aber die Entscheidungen, Bindungen und Entwicklungen des Helden bleiben bedeutsam. Bewohner dürfen nicht nachträglich zu bedeutungslosen Dekorationen erklärt werden.

## 3. Jede große Enthüllung verändert die Spielmechanik
...
## 📝 scope-basisspiel-und-erweiterung.md — ./60-produktion/scope-basisspiel-und-erweiterung.md

---
title: Scope – Basisspiel und Erweiterung
status: accepted-outline
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
...
- vollständiger Krieg gegen alle großen Ether-Entitäten;
- endgültige Erklärung jeder Sphäre Heras;
- Verwandlung des Helden in eine Ether-Entität;
- physische Rückkehr des Helden nach Era;
- Antwort auf seine spätere Rolle auf Era.

## Erweiterung

Die Erweiterung umfasst:

- Konflikt mit den übrigen großen Ether-Entitäten;
- Reise durch weitere Sphären Heras;
- zunehmende Veränderung der Existenzform des Helden;
- seine eigene Etherwerdung;
- Möglichkeit der physischen Rückkehr nach Era;
- bewusst offenes Ende.

## Umfangsrisiko

Die Weltkonzeption ist deutlich größer als ein einzelnes Spiel. Für die Produktion muss das Basisspiel daher nur so viele Ebenen enthalten, wie nötig sind, um Wiederherstellung, Bindung, Enthüllung und Umkehr überzeugend zu tragen. Die gesamte Kosmologie muss nicht vollständig bereist werden.

---

## 📝 CHECKLIST-ZUR-FREIGABE.md — ./CHECKLIST-ZUR-FREIGABE.md
...
## 📁 00 – Grundlagen
- 🗂️ [Übersicht](00-grundlagen/00-grundlagen.md)
- 📝 [Begriffe und Namen](00-grundlagen/begriffe-und-namen.md)
- 📝 [Kanon und offene Fragen](00-grundlagen/kanon-und-offene-fragen.md)
- 📝 [Spielvision](00-grundlagen/spielvision.md)

## 📁 10 – Welt
- 🗂️ [Übersicht](10-welt/10-welt.md)
...
- 📝 [Ratgeber im Heldenraum](20-handlung/ratgeber-im-heldenraum.md)
- 📝 [Spielablauf und Abschnittsstruktur](20-handlung/spielablauf-und-abschnittsstruktur.md)
- 📝 [Der Talisman](20-handlung/talisman.md)

## 📁 30 – Spielmechanik
- 🗂️ [Übersicht](30-spielmechanik/30-spielmechanik.md)
- 📝 [Kampfsystem – Grundlage](30-spielmechanik/kampfsystem-grundlage.md)
- 📝 [Kernspielschleife](30-spielmechanik/kernspielschleife.md)
- 📝 [Seelenenergie im Endgame](30-spielmechanik/seelenenergie-im-endgame.md)
- 📝 [Wiederherstellungsfortschritt](30-spielmechanik/wiederherstellungsfortschritt.md)

## 📁 40 – Weltsysteme
- 🗂️ [Übersicht](40-weltsysteme/40-weltsysteme.md)
- 📝 [Ebenen, Portale und Weltpassagen](40-weltsysteme/ebenen-portale-und-weltpassagen.md)
- 📝 [Erinnerungs- und Fähigkeitssystem](40-weltsysteme/erinnerungs-und-faehigkeitssystem.md)
- 📝 [Rekonstruktionssystem](40-weltsysteme/rekonstruktionssystem.md)
- 📝 [Seelenökonomie](40-weltsysteme/seelenoekonomie.md)
- 📝 [Sol, Yol, Zeit und Jahreszeiten als Weltsystem](40-weltsysteme/sol-yol-zeit-und-jahreszeiten.md)

## 📁 50 – Inhalte
- 🗂️ [Übersicht](50-inhalte/50-inhalte.md)
- 📝 [Boss- und Endgame-Abfolge](50-inhalte/boss-und-endgame-abfolge.md)
- 📝 [Monsterhöhlen und Versiegelungen](50-inhalte/monsterhoehlen-und-versiegelungen.md)
- 📝 [Welt- und Ebenenstruktur](50-inhalte/welt-und-ebenenstruktur.md)
...
## 📁 Entscheidungen
- 🗂️ [Übersicht](entscheidungen/entscheidungen.md)
- 📝 [ADR-0001 – Namensnormalisierung](entscheidungen/ADR-0001-namensnormalisierung.md)
- 📝 [ADR-0002 – Wiederherstellungsreihenfolge](entscheidungen/ADR-0002-wiederherstellungsreihenfolge.md)
- 📝 [ADR-0003 – Verdeckte Wahrheit der Spielwelt](entscheidungen/ADR-0003-verdeckte-wahrheit-der-spielwelt.md)
- 📝 [ADR-0004 – Trennung von Basisspiel und Erweiterung](entscheidungen/ADR-0004-basisspiel-und-erweiterung.md)
- 📝 [ADR-0005 – Kanonfreigabe der Checkliste](entscheidungen/ADR-0005-kanonfreigabe-checkliste.md)
- 📝 [ADR-0006 – Gelehrtenüberlieferungen](entscheidungen/ADR-0006-gelehrtenueberlieferungen.md)
- 📝 [ADR-0007 – Seelenkreislauf, Wiedergeburt und Seelenentstehung](entscheidungen/ADR-0007-seelenkreislauf-wiedergeburt-und-seelenentstehung.md)
- 📝 [ADR-0008 – Achtteiliger Spielablauf](entscheidungen/ADR-0008-achtteiliger-spielablauf.md)

<!-- AUTO-GENERATED:docs-index END -->

---

## 📝 ADR-0001-namensnormalisierung.md — ./entscheidungen/ADR-0001-namensnormalisierung.md
...
## 📝 ADR-0002-wiederherstellungsreihenfolge.md — ./entscheidungen/ADR-0002-wiederherstellungsreihenfolge.md

---
title: ADR-0002 – Wiederherstellungsreihenfolge
status: accepted
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
[← Zurück](entscheidungen.md)
<!-- AUTO-GENERATED:backlink END -->
# ADR-0002 – Wiederherstellungsreihenfolge

## Kontext

Die Wiederherstellung ist der Kern von Handlung, Weltentwicklung und Charakterfortschritt. Ohne feste Hierarchie könnten Gebiete beliebig wirken und Fähigkeiten von der Weltgeschichte getrennt werden.

## Entscheidung

Die übergeordnete Reihenfolge lautet:

1. Länder und Gebiete;
2. Natur und Landschaft;
3. Seelen und Bewohner;
4. Städte und Siedlungen;
5. Erinnerungen und Geschichte;
6. Fähigkeiten des Helden.

## Folgen

- Fähigkeiten werden bevorzugt aus Erinnerungen oder Geschichte abgeleitet.
- Weltzustände müssen diese Stufen persistent abbilden.
- Regionen dürfen Stufen zusammenfassen, aber die globale Dramaturgie nicht ohne Begründung umkehren.
- Der Vertical Slice zeigt mindestens Landschaftsrekonstruktion, eine zurückkehrende Seele und eine erinnerungsbasierte Verbesserung.

---

## 📝 ADR-0003-verdeckte-wahrheit-der-spielwelt.md — ./entscheidungen/ADR-0003-verdeckte-wahrheit-der-spielwelt.md

---
title: ADR-0003 – Verdeckte Wahrheit der Spielwelt
status: accepted
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
[← Zurück](entscheidungen.md)
<!-- AUTO-GENERATED:backlink END -->
# ADR-0003 – Verdeckte Wahrheit der Spielwelt

## Kontext

Der Spieler erlebt die Welt zunächst als echte, zerstörte Heimat. Die spätere Erkenntnis soll die gesamte Reise neu einordnen und das Endgame auslösen.
...
- Frühere Inhalte dürfen die Wahrheit andeuten, aber nicht zu früh eindeutig beweisen.
- Der Talisman entschlüsselt die Fassade schrittweise.
- Die Enthüllung schaltet die Seelenenergie- und Rückkehrphase frei.
- Die emotionale Bedeutung geretteter Bewohner und Orte bleibt trotz künstlichen Ursprungs bestehen.

---

## 📝 ADR-0004-basisspiel-und-erweiterung.md — ./entscheidungen/ADR-0004-basisspiel-und-erweiterung.md

---
title: ADR-0004 – Trennung von Basisspiel und Erweiterung
status: accepted
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
[← Zurück](entscheidungen.md)
<!-- AUTO-GENERATED:backlink END -->
# ADR-0004 – Trennung von Basisspiel und Erweiterung

## Kontext

Die Gesamtkosmologie umfasst zehn große Ether-Entitäten und zahlreiche Sphären. Dieser Umfang übersteigt den notwendigen Rahmen der ersten abgeschlossenen Spielerfahrung.
...
- Das Basisspiel benötigt einen eigenständigen, befriedigenden Abschluss nach Semm.
...
## 📝 ADR-0005-kanonfreigabe-checkliste.md — ./entscheidungen/ADR-0005-kanonfreigabe-checkliste.md
...
## 📝 ADR-0006-gelehrtenueberlieferungen.md — ./entscheidungen/ADR-0006-gelehrtenueberlieferungen.md
...
## 📝 ADR-0007-seelenkreislauf-wiedergeburt-und-seelenentstehung.md — ./entscheidungen/ADR-0007-seelenkreislauf-wiedergeburt-und-seelenentstehung.md
...
## 📝 ADR-0008-achtteiliger-spielablauf.md — ./entscheidungen/ADR-0008-achtteiliger-spielablauf.md

---
title: ADR-0008 – Achtteiliger Spielablauf
status: accepted
updated: 2026-08-30
---
<!-- AUTO-GENERATED:backlink START -->
[← Zurück](entscheidungen.md)
<!-- AUTO-GENERATED:backlink END -->
# ADR-0008 – Achtteiliger Spielablauf

## Kontext

Die Wiederherstellungsfolge beschrieb zunächst keine feste Gebietsfolge. Eine
ältere Arbeitsfassung verwendete sechs Kapitel und verband den Talisman bereits
am Anfang mit der Ratgeberfunktion.

## Entscheidung

Das Basisspiel besitzt acht Makroabschnitte:
...
5. Tatok I;
6. Tatok II;
7. Tatok III mit dem Weg zu Tator;
8. Semms Bereich mit dem letzten Bosskampf.

Der Graslandabschnitt führt Landschaft, Gebäude, Bewohner, Erinnerungen und
erworbenes Wissen ein. Er beginnt im Heldenraum, führt über Nebel und Turm ins
Grasland und umfasst danach Sägewerk, Wasserwerk, Lichterhaus und den sozialen
Dorfabschluss.

Der Hut-Ratgeber ist nicht der Talisman. Der Held bemerkt den Talisman erst
nach dem Boss des Lichterhauses bewusst und erhält dann eine kleine persönliche
Erinnerung.

Nach der Hauptstadt folgt die zweite Reise durch befreite Gebiete. Sie
verbindet Enthüllung, Aufnahme der Seelenmacht und Ausbruch, ist aber kein
zusätzlicher Makroabschnitt. Danach folgen drei Passagen in Tatok und Semms
eigener Schlussabschnitt.

Die gesprochenen Formen „Tatos Welt“ und „Zenz Welt“ begründen keine neuen
Namen. Es gelten **Tatok** und **Semm**. **Zehsen** bleibt Weltenbewahrer,
Verbündeter Tators und Ursprung des Talismans; diese Entscheidung macht ihn
nicht zum Endgegner.

## Folgen

- Die Sechs-Kapitel-Arbeitsfassung ist überholt.
- Der Einstieg besitzt einen sichtbaren Ratgeber; der Talisman bleibt zunächst
  unbemerkt.
- Der Graslandabschnitt zeigt die Wiederherstellungsstufen nacheinander.
- Wald, Hochland, Hauptstadt, Tatok und Semms Bereich benötigen weitere
  Einzelentscheidungen.
- Wasserfallhöhe und ungefähr zwanzig Lampenräume bleiben veränderbare
  Entwurfswerte.

Der ausführliche Ablauf steht unter
[Spielablauf und Abschnittsstruktur](../20-handlung/spielablauf-und-abschnittsstruktur.md).

---

## 📝 entscheidungen.md — ./entscheidungen/entscheidungen.md
...
## 📄 Seiten
- 📝 [ADR-0001 – Namensnormalisierung](ADR-0001-namensnormalisierung.md)
...
- 📝 [ADR-0008 – Achtteiliger Spielablauf](ADR-0008-achtteiliger-spielablauf.md)

<!-- AUTO-GENERATED:docs-index END -->

---

## 📝 index.md — ./entscheidungen/index.md
