...
# Verbindliches deutsches Spielkonzept
...
## 📁 00 overview
- 🗂️ [Overview](00-overview/00-overview.md)
...
## 📁 01 baseline
- 🗂️ [Overview](01-baseline/01-baseline.md)
...
- 📝 [Sprachrichtlinie](01-baseline/language-policy.md)
- 📝 [Umfang und Nicht-Ziele](01-baseline/scope-and-non-goals.md)
- 📝 [Terminologie](01-baseline/terminology.md)
...
## 📁 04 combat
- 🗂️ [Overview](04-combat/04-combat.md)
- 📝 [Kampfsystem](04-combat/combat-system.md)

## 📁 05 machines
- 🗂️ [Overview](05-machines/05-machines.md)
- 📝 [Maschinensystem](05-machines/machine-system.md)

## 📁 06 zuro and enemies
- 🗂️ [Overview](06-zuro-and-enemies/06-zuro-and-enemies.md)
...
- 📝 [EF-DEC-<Nummer>: <Entscheidungstitel>](templates/decision-template.md)
- 📝 [<Titel>](templates/media-entry-template.md)
- 📝 [TEST-<Nummer>: <Testtitel>](templates/prototype-test-template.md)
- 📝 [Systemname](templates/system-design-template.md)

<!-- AUTO-GENERATED:docs-index END -->

Diese automatisch erzeugte Navigation erschließt die deutschsprachige
Konzeptquelle. Der verbindliche Einstieg bleibt [index.md](index.md).
